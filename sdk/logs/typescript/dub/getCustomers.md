...
- Request parameters: email (string), externalId (string), includeExpandedFields (boolean)
- Response: Array of Customer objects with nested Link, Partner, and Discount objects

2. We'll create specific types for each nested object structure:
- CustomerLink
- CustomerPartner
- CustomerDiscount
- Customer
...
- Return typed customer data

Here's the implementation:

```typescript:customers.ts
