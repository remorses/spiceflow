...
2. Create a method that takes idOrSlug as a parameter and makes a GET request
3. Handle the response by parsing it and checking for errors
4. Add proper typing for both input and output
5. Include error handling for different status codes
6. Add the required JSDoc comment with route information
...
// ... existing ExampleError class and streamSSEResponse function ...
