...
- CreateLinkRequest: Based on the request body schema
- LinkSchema: Based on the response schema
- ErrorResponse: For handling error responses

2. The createLink method needs to:
- Accept the request parameters
- Make a POST request to /links
- Handle successful responses by returning the LinkSchema
- Handle errors by throwing ExampleError with status and data
