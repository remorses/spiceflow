...
- Name: standalone-federation.test.ts >> standalone federation consumer >> shadow DOM: CSS is inside shadow root, not in document.head
- Location: e2e/standalone-federation.test.ts:92:3
